...
<div id="panel-container" class="rounded shadow">
    ...
    <div id="content">
    	...
    	<form method="post" action="/competentielijst-toevoegen">
	        ...
	        <label class="form_label" for="competenties">Bedrijven</label>
            <% for(StageBedrijf sb : alleBedrijven) { %>
                <label class="form_checkbox_label"><input type="checkbox" name="competenties" value="<%=sb.getId()%>"><%=sb.getNaam()%></label>
			<% } %>
